...
//=========  (Thu May 28 13:48:17 2020) by ROOT version 6.16/00
...
// ------------>Primitives in pad: Check_1
   ...
   h_SynRadAna_Normalization__1->SetBinContent(4,1120846);
   h_SynRadAna_Normalization__1->SetBinContent(5,1000000);
   h_SynRadAna_Normalization__1->SetBinContent(6,1120846);
   ...
   h_SynRadAna_Normalization__1->SetBinError(4,1173.549);
   h_SynRadAna_Normalization__1->SetBinError(5,1000);
   h_SynRadAna_Normalization__1->SetBinError(6,1173.549);
...
// ------------>Primitives in pad: Check_3
   ...
   Check_3->Draw();
   Check_3->cd();
   Check_3->Range(-4.753164,7.908021,21.82911,15.90298);
   ...
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(1,1.679704e+15);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(2,7.283735e+09);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(3,1.43163e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(4,2.433169e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(5,1.779065e+11);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(6,5.99848e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinContent(7,1.237668e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(1,1.735162e+12);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(2,4.205908e+09);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(3,5.845518e+09);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(4,7.697041e+09);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(5,2.097773e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(6,1.226569e+10);
   h_SynRadAna_MVTXHit_nHit_flux__3->SetBinError(7,5.540294e+09);
...
// ------------>Primitives in pad: Check_4
   ...
   Check_4->Draw();
   Check_4->cd();
   Check_4->Range(-4.753164,8.330248,21.82911,15.88075);
   ...
   h_SynRadAna_MVTX_nHit_flux__4->SetBinContent(1,1.679694e+15);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinContent(2,2.42834e+10);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinContent(3,2.693487e+11);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinContent(4,1.25056e+10);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinError(1,1.735155e+12);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinError(2,7.682511e+09);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinError(3,2.582004e+10);
   h_SynRadAna_MVTX_nHit_flux__4->SetBinError(4,5.597506e+09);
