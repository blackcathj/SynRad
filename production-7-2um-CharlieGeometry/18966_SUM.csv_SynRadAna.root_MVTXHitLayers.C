...
// ------------>Primitives in pad: MVTXHitLayers_1
   ...
   MVTXHitLayers_1->cd();
   MVTXHitLayers_1->Range(-1.107595,21.3255,2.689873,22.05798);
   ...
   h_SynRadAna_MVTXHit_nHit_Layer_py->SetBinContent(1,5.543273e+21);
   h_SynRadAna_MVTXHit_nHit_Layer_py->SetBinError(1,5.004053e+17);
   h_SynRadAna_MVTXHit_nHit_Layer_py->SetEntries(2.001e+08);
